package Kr.levelsElements.enemies.concreteEnemies;

import Kr.levelsElements.enemies.templates.AttackDamage;
import Kr.levelsElements.enemies.templates.Enemy;
import Kr.levelsElements.enemies.templates.EnemyAttackDamageModifier;
import Kr.levelsElements.enemies.traits.canChangeAttackDamage;

public class Orc extends Enemy implements canChangeAttackDamage {
  ...
  private final AttackDamage baseAttackDamage = new AttackDamage(6.0, 4, 8);

  // current values
  private AttackDamage currentAttackDamage = baseAttackDamage;

  int speedInNodes = 3;
  double physicalArmor = 30;
  double magicArmor = 0;
